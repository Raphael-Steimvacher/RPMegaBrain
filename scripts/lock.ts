...
const value = { schema_version: 1, runtime_version: pkg.version, node_minimum: '24.0.0', codex_sdk_version: null,
  eval_suite_version: '0.2.0-deterministic', checkpoint_schema_version: 1, memory_schema_version: 1,
  retrieval_schema_version: 1, telemetry_schema_version: 2, components: componentHashes(coreRoot) };
