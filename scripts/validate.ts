...
import { v5SchemaNames } from '../src/infrastructure/v5/validation.js';
...
for (const name of v5SchemaNames) if (!existsSync(join(coreRoot, 'core/schemas/v5', `${name}.schema.json`))) throw new Error(`Schema v0.5 ausente: ${name}.`);
...
console.log(`${documents.length + v2Documents.length + 2} documentos, 24 casos v0.2, 37 casos v0.3, schemas v0.4/v0.5 e skill memory-curator válidos.`);
